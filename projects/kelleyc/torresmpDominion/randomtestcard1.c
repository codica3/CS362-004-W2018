...
**
** Original inputs: int i (loop counter), int current player (cp), struct valid
** gameState *s, and int handPos (hp).
**
...
**
** New inputs: struct valid gameState *state and int handPos.
********************************************************************************/
